...
//  products from makeup API and display them
...
function topFunction() {
  document.body.scrollTop = 0; // For mac user (Safari)
  document.documentElement.scrollTop = 0; // For window users (Chrome, Firefox, IE and Opera)
}
